...
class TransactionRequest
{
    ...
    /**
     * @return the $studepartment
     */
    public function getstudepartment()
    {
        return $this->studepartment;
    }

    /**
     * @param string $studepartment
     */
    public function setstudepartment($studepartment)
    {
     ...
     * @return the $studepartment
     */
    public function getstushift()
    {
        return $this->stushift;
    }

    /**
     * @param string $stushift
     */
    public function setstushift($stushift)
    {
        $this->stushift = $stushift;
    }
    ...
    private function getData()
    {
        ...
        $strReqst .= "&udf9=" . $this->getstushift();
        $strReqst .= "&udf6=" . $this->getstudepartment();
